...
Tres invocaciones del módulo `os.path` resuelven el quest:
...
La validación se reduce a comparar `commonpath([working_dir_abs, resolved_target_path])` con `working_dir_abs`. Si difieren, la ruta escapó.
